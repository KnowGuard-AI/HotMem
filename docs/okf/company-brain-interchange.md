...
Issues [#67](https://github.com/KnowGuard-AI/HotMem/issues/67),
[#68](https://github.com/KnowGuard-AI/HotMem/issues/68), and
[#69](https://github.com/KnowGuard-AI/HotMem/issues/69) are in flight on
`codex/company-brain-67-69`. The normative record, manifest, and hydration
contract defined by #67 is [interchange-v1.md](interchange-v1.md); this
strategy note remains the rationale document. Delivery sequence step 1–3 of §6
maps one-to-one onto those issues.
